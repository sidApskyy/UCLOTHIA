  ...
  return (
    <div className="pt-24 md:pt-32">
      ...
      <div className="container-luxury py-16 md:py-20">
        ...
        <p className="text-micro mt-4">{filtered.length} pieces</p>
      </div>

      {/* Controls */}
      <div className="container-luxury sticky top-[80px] md:top-24 z-10 bg-[var(--color-background)]/95 backdrop-blur-sm py-4 border-y border-[var(--color-border)]">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <label className="text-[0.75rem] tracking-[0.1em] uppercase text-[var(--color-muted)] hidden md:block">
              Sort
            </label>
            <select
              value={sortBy}
        ...
        {/* Filter panel */}
        {showFilters && (
          <div className="mt-6 pt-6 border-t border-[var(--color-border)] grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
