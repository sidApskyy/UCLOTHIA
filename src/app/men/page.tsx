...
import { MenCollection } from "@/components/men/men-collection";
import { Reveal } from "@/components/motion/reveal";
import { LineDraw } from "@/components/motion/line-draw";
import { ParallaxImage } from "@/components/motion/parallax-image";

export const metadata: Metadata = {
  title: "Men — Couture, Sherwanis & Tailored Menswear",
  description:
    "UCLOTHIA Men — sherwanis, bandhgalas, kurta sets, and tailored menswear. Heritage Indian craftsmanship meets contemporary editorial vision.",
  alternates: { canonical: "/men" },
};

const categories = [
  { label: "Sherwanis", href: "/men/sherwanis", desc: "Hand-embroidered heirlooms", img: "/male-single-potrait.jpeg", hoverImg: "/hover-single-male-1.jpeg" },
  { label: "Bandhgalas", href: "/men/bandhgalas", desc: "Architectural tailoring", img: "/single-male-potraite-2.jpeg", hoverImg: "/hover-single-male-2.jpeg" },
  { label: "Kurta Sets", href: "/men/kurta-sets", desc: "Effortless refinement", img: "/males-group-potrait.jpeg", hoverImg: "/hover-single-male-3.jpeg" },
];
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-[3]">
          <div className="container-luxury">
            ...
            <p className="mt-8 md:mt-10 text-[0.9375rem] md:text-[1.125rem] text-white/80 max-w-xl mx-auto leading-[1.7] font-light opacity-0 animate-[fade-in_1000ms_cubic-bezier(0.16,1,0.3,1)_400ms_forwards]">
              Sherwanis, bandhgalas, and tailored menswear where heritage Indian craftsmanship meets contemporary editorial vision.
            </p>
        ...
        <div className="container-luxury max-w-3xl text-center">
          <Reveal variant="fade">
            ...
            <p className="font-display text-2xl md:text-4xl lg:text-5xl font-light italic leading-[1.3] tracking-[-0.01em] text-[var(--color-text)]">
              The modern gentleman wears his heritage with quiet confidence and impeccable cut.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-center">
              ...
              <Reveal variant="fade-up" delay={200} className="md:col-span-5 md:pl-4 lg:pl-12">
                ...
                <h2 className="font-display text-2xl md:text-3xl lg:text-4xl font-light leading-[1.15] tracking-[-0.02em] mb-6">
                  The Art of <span className="italic text-[var(--color-muted)]">Tailoring</span>
                </h2>
